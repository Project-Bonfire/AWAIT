...
def declare_signals(noc_file, network_dime_x, network_dime_y, vc):
    ...
    noc_file.write("\n")
    for i in range(0, network_dime_x*network_dime_y):
        noc_file.write("\tsignal hold_in_N_"+str(i)+", hold_in_E_"+str(i)+", hold_in_W_"+str(i) +
                       ", hold_in_S_"+str(i)+ ", hold_in_L_"+str(i) + ": std_logic;\n")
    noc_file.write("\n")
    for i in range(0, network_dime_x*network_dime_y):
        noc_file.write("\tsignal hold_out_"+str(i) + ": std_logic;\n")
    noc_file.write("\n")
    for i in range(0, network_dime_x*network_dime_y):
